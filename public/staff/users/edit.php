...
if(is_post_request() && request_is_same_domain()) {
  ...
  if (is_blank($user['confirm']) || is_blank($user['password'])) {
...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo h(u($user['id'])); ?>" method="post">
    ...
    Passwords should be at least 12 characters and include at least one uppercase letter, lowercase letter, number, and symbol. <br />
    Confirm password: <br />
